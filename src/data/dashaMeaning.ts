...
export const MAHA_MEANING: Record<string, ChapterMeaning> = {
  ...
  Mercury: {
    ...
    meaning: 'A quick, curious, connective chapter. Learning, communication, business, and clever problem-solving all come alive. It’s a great window for study, writing, deals, and networks. It rewards you for keeping your word and organising the noise into a plan.',
  },
  Jupiter: {
